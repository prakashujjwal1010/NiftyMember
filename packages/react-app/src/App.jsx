...
function App(props) {
  ...
  const tokensTypes = ["Exclusive Memberships", "Proof of Fandom", "Streaming Memberships"]
    ...
    <div className="App">
      ...
      <BrowserRouter>
        ...
        <Menu style={{ textAlign:"center" }} selectedKeys={[route]} mode="horizontal">
          <Menu.Item key="/">
            <Link onClick={()=>{setRoute("/")}} to="/">Owned</Link>
          </Menu.Item>
          <Menu.Item key="/created">
            <Link onClick={()=>{setRoute("/created")}} to="/created">Created</Link>
          </Menu.Item>
          <Menu.Item key="/create-new">
            <Link onClick={()=>{setRoute("/create-new")}} to="/create-new">Create New</Link>
          </Menu.Item>
